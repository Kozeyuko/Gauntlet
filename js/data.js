...
export const LOCATION_LIST = [
  { key: "home", label: "Home" },
  { key: "spar", label: "Iron Spar" },
  { key: "wat", label: "Wat Chai" },
  { key: "tatami", label: "Tatami" },
  { key: "roda", label: "Roda" },
  { key: "dohyo", label: "Dohyo" },
  { key: "foundry", label: "Foundry" },
  { key: "mikazuki", label: "Mikazuchi Dojo" },
  { key: "stormpg", label: "Storm Pagoda" },
  { key: "lightning", label: "Lightning Alley" },
  { key: "sanctum", label: "Sanctum" },
  { key: "estate", label: "Kure Estate" },
  { key: "clinic", label: "Clinic" },
  { key: "arena", label: "Arena" },
  { key: "inside", label: "The Inside" },
  { key: "oldhouse", label: "Old House" },
  { key: "niko", label: "Boundless Dojo" },
  { key: "raishin", label: "Raishin Temple" },
  { key: "spirit", label: "Blood Dojo" },
  { key: "kaiwan", label: "Iron Hall" },
  { key: "silat", label: "Pencak Hall" },
  { key: "hunt", label: "Deepwood Lodge" },
  { key: "sword", label: "Daidoji Manor" },
  { key: "xiyi", label: "Five-Element Gate" },
  { key: "kyoku", label: "Kyokushin Dojo" },
  { key: "shotokan", label: "Shotokan Hall" },
  { key: "taekwon", label: "TKD Dojang" },
  { key: "wrestling", label: "Wrestling Pit" },
  { key: "kickbox", label: "Kickbox Club" },
  { key: "kungfu", label: "Shaolin Yard" },
  { key: "aikido", label: "Aiki Circle" },
  { key: "kali", label: "Arnis Ring" },
  { key: "ironbox", label: "Iron Foundry Gym" },
  { key: "boran", label: "Boran Camp" },
  { key: "guihun", label: "Demon's Crucible" },
  { key: "ultra", label: "Still Point" },
];
